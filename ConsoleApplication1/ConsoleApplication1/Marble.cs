...
namespace QuickTest
{
    public class Marbles
    {
        ...
        //Generate a random number based on a set of probalilities in integer form
        ...
        {
            // output the total number of red, green, blue and orange marbles based on the array of results passed into you.
