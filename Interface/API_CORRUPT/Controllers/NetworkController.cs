...
namespace API.Controllers
{
    ...
    {
        // GET: Network
        [HttpGet, Route("Domain/{tokenValue}/{domain}/{ObjectClass}/{objectGUID}/{position}/{count}/{orderBy}")]
        public IHttpActionResult GetDependencyInforamtion(Guid tokenValue, string domain, string ObjectClass, Guid objectGUID, int position, int count, string orderBy, AI.V2.BaseLibrary.Direction direction)
        {
            ...
            Dependencies = this.GetDependencies(domain, domainID, objectClassID, objectGUID, position, count, orderBy,direction);
            Dependant = this.GetDependents(domain, domainID, objectClassID, objectGUID, position, count, orderBy,direction);
        ...
        private List<Dependant> GetDependents(string domain, int domainID, int objectClassID, Guid objectGUID, int position, int count, string orderBy,AI.V2.BaseLibrary.Direction direction)
        {
            ...
            string strstr = "Select * from Dependant Where SubjectClassID=" + objectClassID + "SubjectGUID=" + objectClassID;
        ...
        private List<Dependency> GetDependencies(string domain, int domainID, int objectClassID, Guid objectGUID, int position, int count, string orderBy, AI.V2.BaseLibrary.Direction direction)
        {
            List<AI.V2.BaseLibrary.Dependency> dList = new List<AI.V2.BaseLibrary.Dependency>();
            AI.V2.BaseLibrary.Dependency d = new AI.V2.BaseLibrary.Dependency();
            string strstr = "Select * from Dependency Where PredicateClassID=" + objectClassID + "PredicateGUID=" + objectClassID;
            if (direction == AI.V2.BaseLibrary.Direction.Descending)
            {
                switch (orderBy)
                {
